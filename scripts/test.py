...
def heatmap_model_output():
    ...
    filters_from_scratch2 = np.array([[2.2995e+00, 1.0191e+00, 1.0000e+00],
        [8.0233e-01, 1.6248e+01, 1.0000e+00],
        [2.1794e+01, 7.7807e-01, 0.0000e+00],
        [1.8917e+01, 6.5584e-01, 0.0000e+00],
        [7.5607e-02, 3.9207e+01, 1.0000e+00],
    ...
    heatmap3 = axes[2].imshow(filters_from_scratch2[:, :2], cmap="magma", interpolation="nearest", vmax=30.0)
    fig.colorbar(heatmap3, ax=axes[2])
    axes[2].set_title('FR of learning filters from scratch (epoch 14)')
